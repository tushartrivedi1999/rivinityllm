    ...
    <DashboardShell title="Inference Playground">
      <div className="grid gap-4 lg:grid-cols-[1fr_320px]">
        ...
        <Card className="space-y-3">
          <p className="font-medium">10T MoE Runtime Insight</p>
          <p className="text-sm text-zinc-300">Dense 10T models are unrealistic (20TB FP16 / 5TB 4-bit). Rivinity uses sparse MoE + layer streaming + quantization.</p>
          <ul className="list-disc space-y-1 pl-5 text-xs text-zinc-400">
            <li>Total params: 10T</li>
            <li>Experts: 256</li>
            <li>Active experts per token: 2</li>
            <li>Active params: ~40B</li>
            <li>Estimated active memory: ~20GB (4-bit)</li>
            <li>Expert sharding: 4 nodes (0-63, 64-127, 128-191, 192-255)</li>
            <li>KV cache: 4-bit quantized + paged cache</li>
            <li>Dynamic experts: NVMe -> RAM -> GPU</li>
          </ul>
        </Card>
        </div>
      </div>
